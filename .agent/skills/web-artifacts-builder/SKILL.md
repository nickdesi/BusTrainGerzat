...
1. Initialize the frontend repo using `.agent/skills/web-artifacts-builder/scripts/init-artifact.sh`.
...
```bash
bash .agent/skills/web-artifacts-builder/scripts/init-artifact.sh <project-name>
cd <project-name>
```
