...
export default function BusMap({ showStops = true }: BusMapProps) {
    ...
    return (
        <div className={`relative h-full min-h-[min(72dvh,720px)] w-full overflow-hidden rounded-[1.25rem] border border-white/10 bg-slate-950 shadow-[0_16px_45px_rgba(0,0,0,0.34)] ring-1 ring-white/5 md:min-h-[420px] md:rounded-[2rem] md:shadow-[0_28px_90px_rgba(0,0,0,0.45)] ${isDarkMode ? 'map-dark' : 'map-light'}`}>
