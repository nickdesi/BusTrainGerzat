  ...
  return (
    <main id="main-content" className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(253,195,0,0.16),transparent_32%),radial-gradient(circle_at_top_right,rgba(59,130,246,0.12),transparent_28%),linear-gradient(135deg,var(--color-background),var(--color-surface-dark)_48%,#050505)] text-gray-100 font-sans">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-5 md:py-8">
        ...
        <header className="mb-8 relative overflow-hidden rounded-[2rem] border border-yellow-500/20 bg-black/25 p-4 shadow-2xl shadow-black/30 backdrop-blur-xl md:p-6">
          <div className="absolute -right-16 -top-16 h-44 w-44 rounded-full bg-yellow-500/10 blur-3xl" aria-hidden="true" />
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6 relative">
            <div className="text-center lg:text-left">
              <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-yellow-500/25 bg-yellow-500/10 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.2em] text-yellow-300">
              ...
              <h1 className="text-3xl md:text-5xl font-bold tracking-wider text-yellow-500 uppercase mb-2 font-mono text-glow flex items-center gap-3 justify-center lg:justify-start">
                <Image src="/icon-512.png" alt="Logo Gerzat Live" width={48} height={48} priority className="w-8 h-8 md:w-12 md:h-12 drop-shadow-[0_0_18px_rgba(253,195,0,0.35)]" />
                DÉPARTS • GERZAT
              </h1>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-3">
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
              <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-gray-500"><Activity className="h-4 w-4 text-yellow-400" /> Passages</div>
              <p className="mt-2 text-3xl font-black text-white">{departureStats.total}</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
              ...
              <p className="mt-2 text-3xl font-black text-white">{departureStats.realtime}</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
              ...
              <p className="mt-2 text-3xl font-black text-white">{departureStats.favorites}</p>
            </div>
          </div>
